...
<table class="ECUAddresses">
 <tr>
  ...
  <td class="ColHeader" colspan="4">Protocols</td>
 ...
 <tr>
  ...
  <td class="ColHeader" width="40" colspan="1">LA-Can</td>
  <td class="ColHeader" width="40" colspan="1">LA-DoIP</td>
...
-->     
<xsl:choose>
     <xsl:when test="da:ProtocolList/da:Protocol[@Code='6']">

	  <td class="ECUaddr">
	   <xsl:value-of select="concat('$',da:ProtocolList/da:Protocol[@Code='6']/da:LogicalAddress)"/>
	   <br/>
...
<xsl:choose>
     <xsl:when test="da:ProtocolList/da:Protocol[@Code='9']">

	  <td class="ECUaddr">
	   <xsl:value-of select="concat('$',da:ProtocolList/da:Protocol[@Code='9']/da:LogicalAddress)"/>
	   <br/>
